...
String formno;
     Signupthree(String formno) {
        ...
        carddetails.setBounds(100, 280, 300, 15);
        add(carddetails);
        ...
        pindetails.setBounds(100, 350, 300, 15);
        add(pindetails);
        ...
        c7 = new JCheckBox("I Hearby declers that the above entered details are correct to the best of my knowledge");
        ...
        submit.setBounds(420, 640, 100, 30);
        ...
        cancel.setBounds(220, 640, 100, 30);
           ...
           if (c1.isSelected()){
            ...
            try {
                if (accountType.equals("")){
                    ...
                    Conn conn = new Conn();
                    String quary = "insert into signupthree values('"+formno+"', '"+accountType+"', '"+cardnumber+"', '"+pinnumber+"', '"+facility+"')";
